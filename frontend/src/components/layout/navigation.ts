...
export const navSections: NavSection[] = [
  {
    ...
    items: [
      ...
      { title: "Saved projects", href: "/projects/saved", icon: Bookmark },
      { title: "Applications", href: "/applications", icon: ClipboardList },
      { title: "Interviews", href: "/interviews", icon: BriefcaseBusiness },
      ...
      { title: "My reports", href: "/reports", icon: ScrollText },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Roles", href: "/admin/roles", icon: ShieldCheck, roles: [SystemRoles.Admin] },
      ...
      { title: "Background jobs", href: "/admin/background-jobs", icon: ListChecks, roles: [SystemRoles.Admin] },
